...
func _run_second_timer_timeout() -> void:
	...
	if Data.run_data.round_timer >= Data.run_data.MAXROUNDTIME and not elite_spawned: _spawn_elite()
...
func _spawn_elite() -> void:
	elite_spawned = true
	var to_spawn:EnemyData.Type = EnemyData.Type.ELITE if Data.run_data.current_round < Data.run_data.MAXROUNDCOUNT else EnemyData.Type.BOSS
